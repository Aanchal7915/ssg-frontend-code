...
// const Footer = () => (
//     <>
//         <footer className="w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-950 text-gray-200 border-t border-gray-800 shadow-inner font-sans animate-fade-in">
...
//                         <h1 className="text-xl font-bold text-indigo-300 font-mono tracking-tight mb-1 animate-fade-in">
//                             SSG Platform
//                         </h1>
//                         <p className="text-sm text-gray-400 font-light leading-relaxed mb-2 animate-fade-in">
...
//                                 <path strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z"></path>
...
//                         <a className="text-indigo-400 hover:text-indigo-300 transition transform hover:scale-110 hover:drop-shadow-glow" href="#" aria-label="Facebook">
//                             <svg fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24">
//                                 <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path>
//                             </svg>
//                         </a>
//                         <a className="text-indigo-400 hover:text-indigo-300 transition transform hover:scale-110 hover:drop-shadow-glow" href="#" aria-label="Twitter">
//                             <svg fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24">
//                                 <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
//                             </svg>
//                         </a>
//                         <a className="text-indigo-400 hover:text-indigo-300 transition transform hover:scale-110 hover:drop-shadow-glow" href="#" aria-label="Instagram">
//                             <svg fill="none" stroke="currentColor" className="w-6 h-6" viewBox="0 0 24 24">
//                                 <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
//                                 <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
//                             </svg>
//                         </a>
//                         <a className="text-indigo-400 hover:text-indigo-300 transition transform hover:scale-110 hover:drop-shadow-glow" href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
//                             <svg fill="currentColor" className="w-6 h-6" viewBox="0 0 24 24">
...
//                     <div>
//                         <h2 className="mb-3 text-sm font-bold tracking-widest text-indigo-300 uppercase font-mono animate-fade-in">
//                             Quick links
//                         </h2>
...
//                             </li>
//                              <li>
//                                 <a className="footer-link">featured products</a>
//                             </li>
//                             <li>
...
//                             </li>
//                             <li>
//                                 <a className="footer-link">Help Resources</a>
//                             </li>
//                             <li>
//                                 <a className="footer-link">Release Updates</a>
//                             </li>
//                         </ul>
//                     </div>
//                     <div>
...
//                         <ul className="space-y-2">
//                             <li>
//                                 <a className="footer-link">Terms &amp; Privacy</a>
//                             </li>
//                             <li>
...
//                             </li>
//                             <li>
//                                 <a className="footer-link">Order Status</a>
//                             </li>
//                             <li>
//                                 <a className="footer-link">Return & Refund policy</a>
//                             </li>
//                         </ul>
//                     </div>
//                     <div>
...
//                 <p className="text-md text-gray-400 font-light tracking-wide font-mono animate-fade-in">
...
//             }
//             .footer-link {
//                 @apply hover:text-indigo-400 transition cursor-pointer relative font-medium tracking-wide font-sans;
//             }
//             .footer-link::after {
//                 content: '';
//                 display: block;
