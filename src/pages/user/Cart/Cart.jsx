            ...
            <main className="w-full pt-5 bg-gradient-to-br from-[#e0f7fa] via-[#f1faff] to-[#f0f9ff] min-h-screen text-[#334155]">
                <div className="flex flex-col sm:flex-row gap-3.5 w-full sm:w-11/12 mt-0 sm:mt-4 m-auto">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex flex-col shadow-xl bg-white/80 rounded-xl border border-[#bae6fd]">
                            <span className="font-medium text-lg px-2 sm:px-8 py-4 border-b border-[#bae6fd] text-[#2563eb]">
                            ...
                            {/* Place order btn */}
                            <div className="flex flex-col sm:flex-row justify-between items-center sticky bottom-0 left-0 bg-white border-t border-[#bae6fd] rounded-b-xl">
                                <div
                                ...
                                >
                                    ...
                                    <span className="relative z-10 text-[#38bdf8]">PLACE ORDER</span>
                                </button>
                            </div>
                        </div>
                        {/* Saved for later items container */}
                        <div className="flex flex-col mt-5 shadow-xl bg-white/80 rounded-xl border border-[#bae6fd] mb-8">
                            <span className="font-medium text-lg px-2 sm:px-8 py-4 border-b border-[#bae6fd] text-[#2563eb]">
