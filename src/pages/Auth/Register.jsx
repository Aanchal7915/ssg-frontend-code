                    ...
                    <div className="flex items-center flex-col sm:flex-row md:flow-row lg:flex-row my-10 mx-auto w-full sm:w-[70vw] md:w-[70vw] lg:w-[70vw] min-h-[500px] md:h-[80vh] lg:h-[80vh] bg-white shadow-[0px_0px_8px_2px_rgba(212,212,212,0.6)] ">
                        ...
                        <div className=" w-full md:w-[40%] lg:w-[40%] h-full bg-green-900">
                            <div className="flex gap-6 flex-col h-full mt-10 px-6 ">
                                ...
                                <div className="">
                                    <img src="/register-11.gif" alt="auth image" />
                                </div>
                            </div>
                        </div>

                        {/* sign up form */}
                        <div className="px-10 py-1 pt-0 w-full  sm:w-[60%] md:w-[60%] lg:w-[60%] ">
                            <div className="flex items-center flex-col h-full w-full">
                                ...
                                >
                                    <img 
                                    src="/logo-9.png"
                                    className="w-[150px] h-auto object-cover mx-auto"
                                    alt="logo"
                                    />
                                    <div className="text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7 ">
                                        ...
                                        <div className="relative flex flex-col">
                                            <button className="bg-green-700 uppercase text-white text-[14px] font-[500] rounded-sm px-2 py-1">
                                                Continue
                                            </button>
                                        </div>
                                    </div>
