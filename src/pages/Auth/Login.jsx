...
const Login = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      toast("The backend is starting up, please wait a minute...");
            ...
            <div className="flex-1 flex flex-col justify-center p-6 sm:p-10">
              ...
              >
                ...
                <div className="relative">
                  <span className="absolute left-3 top-2.5 text-[#54B1CE]">
                    <FiMail size={18} />
                  </span>
                  <input
                    autoComplete="on"
                    ...
                    className="pl-10 pr-3 py-2 w-full rounded-lg bg-white border border-[#54B1CE]/50 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#54B1CE] transition"
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-10 py-2 w-full rounded-lg bg-white border border-[#54B1CE]/50 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#54B1CE] transition"
                    placeholder="Password"
                    required
                    minLength="5"
                  />
                  <span
                    className="absolute right-3 top-2.5 text-[#54B1CE] hover:text-[#0e7490] cursor-pointer"
